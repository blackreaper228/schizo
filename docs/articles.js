...
;// ./src/javascript/LandingGoUp.js
var goUp = function goUp() {
  window.addEventListener('scroll', function () {
    var goUpButton = document.querySelector('.A_GoUp');
  ...
  document.querySelector('.A_GoUp').addEventListener('click', function () {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
    });
...
document.addEventListener('DOMContentLoaded', function () {
  LandingGoUp();
  var copyElement = document.getElementById('copyLink');
  if (copyElement) {
    copyElement.addEventListener('click', function () {
      navigator.clipboard.writeText(window.location.href).then(function () {
        return alert('Ссылка скопирована!');
      })["catch"](function () {
        return alert('Не удалось скопировать ссылку.');
      });
    });
  }
});
