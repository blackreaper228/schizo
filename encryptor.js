...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var subMenu = document.querySelector('.M_HeaderNavbar.invert');
  var subMenuBetween = document.querySelector('#main_nav');
  var ArticleMobile = document.querySelector('#ArticleMobile');
  var ArticlesDropdown = document.querySelector('#ArticlesDropdown');
  var GensMobile = document.querySelector('#GensMobile');
  // const GensDropdown = document.querySelector('#GensDropdown')

  var isHovered = false;
  var isArticlesClicked = false;
  var isGensClicked = false;
  articlesBtn.addEventListener('mouseenter', function () {
    subMenu.style.display = 'flex';
  });
  ...
  ArticleMobile.addEventListener('click', function () {
...
var binaryCode = document.querySelector('#binaryCode');
var caesar = document.querySelector('#caesar');
var atbash = document.querySelector('#atbash');
var EncryptorTitle = document.querySelector('#EncryptorTitle');
var ContentInput = document.querySelector('.W_EncryptorContentInput');
var Annotation = document.querySelector('#Annotation');
var QuestionMark = document.querySelector('.Q_EncryptorContentAnnotationQuestionMark');
var ContentInterface = document.querySelector('.W_EncryptorContentInterface');
var O_EncryptorContent = document.querySelector('.O_EncryptorContent');
var soon = document.querySelector('#soon');
var submitBtn = document.querySelector('.A_EncryptorContentButton');
caesar.addEventListener('click', function () {
  ...
  Annotation.innerText = 'Шифр Цезаря — это простой шифр подстановки, в котором каждая буква в тексте сдвигается на фиксированное число позиций по алфавиту. Например, при сдвиге на 3 «А» становится «Г», «Б» — «Д» и так далее.';
...
atbash.addEventListener('click', function () {
  ...
  ContentInput.style.display = 'none';
  ContentInterface.style.display = 'none';
  Annotation.innerText = 'Шифр Атбаш — это простой метод замены, в котором буквы алфавита заменяются на их зеркальные соответствия: первая буква становится последней, вторая — предпоследней и так далее. Например «А» заменяется на «Я» или «Б» на «Ю».';
  QuestionMark.style.top = '-10px';
  O_EncryptorContent.style.justifyContent = 'center';
  O_EncryptorContent.style.alignItems = 'center';
  soon.style.display = 'flex';
...
binaryCode.addEventListener('click', function () {
  ...
  ContentInput.style.display = 'none';
  Annotation.innerText = 'Двоичный код — это система счисления, использующая только два символа: 0 и 1, применяемая в компьютерах для представления данных.';
...
document.addEventListener('DOMContentLoaded', function () {
  var backButton = document.querySelector('.A_GoBack');
  if (backButton) {
...
document.addEventListener('DOMContentLoaded', function () {
  var titleElements = document.querySelectorAll('h1, h2, h3, h4.side, h5.side'); // Выбираем все h1, h2 и h3
...
// EXTERNAL MODULE: ./src/javascript/goBack.js
var goBack = __webpack_require__(8351);
// EXTERNAL MODULE: ./src/javascript/data-text.js
var data_text = __webpack_require__(8688);
;// ./src/svg/encryptor/A_EncryptorContentInterfaceWindowCopyBtnDone.svg
const A_EncryptorContentInterfaceWindowCopyBtnDone_namespaceObject = __webpack_require__.p + "images/2f19321b70751deecf6e.svg";
// EXTERNAL MODULE: ./src/javascript/encryptorSelector.js
var encryptorSelector = __webpack_require__(6741);
...
const Q_SearchIcon_namespaceObject = __webpack_require__.p + "images/8ce5224e64dca1f5bcc9.svg";
;// ./src/images/Q_LogoMobile.png
const Q_LogoMobile_namespaceObject = __webpack_require__.p + "images/e9c9b183788f82a262d8.png";
...
var newsItems = [{
  ...
  text: 'НЛО на видео Пентагона ↗',
  href: './ufo-on-video.html'
}, {
...
var Header = function Header() {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "A_HeaderNews"
  }, _toConsumableArray(Array(3)).map(function (_, i) {
    return /*#__PURE__*/react.createElement("div", {
      key: i
    }, newsItems.map(function (item, j) {
      return /*#__PURE__*/react.createElement("a", {
        className: "A_NewsLink",
        key: j,
        href: item.href
      }, item.text);
    }));
  })), /*#__PURE__*/react.createElement("div", {
    className: "W_HeaderNavbarsWrap"
  }, /*#__PURE__*/react.createElement("div", {
    ...
    className: "A_HeaderNavbarBtn",
    id: "articles_in"
  }, "\u041F\u0440\u043E\u0448\u043B\u043E\u0435"))), /*#__PURE__*/react.createElement("div", {
...
function mountHeader() {
  ...
  if (navbar) {
    var navbarRoot = (0,client.createRoot)(navbar);
    navbarRoot.render(/*#__PURE__*/react.createElement(header, null));
  }
}
;// ./src/javascript/encryptor.js
function encryptor_toConsumableArray(arr) { return encryptor_arrayWithoutHoles(arr) || encryptor_iterableToArray(arr) || encryptor_unsupportedIterableToArray(arr) || encryptor_nonIterableSpread(); }
function encryptor_nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function encryptor_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return encryptor_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return encryptor_arrayLikeToArray(o, minLen); }
function encryptor_iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function encryptor_arrayWithoutHoles(arr) { if (Array.isArray(arr)) return encryptor_arrayLikeToArray(arr); }
function encryptor_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
...
var switchEl = document.querySelector('.A_EncryptorContentInterfaceSwitchBtn');
var deleteEl = document.querySelector('.A_EncryptorContentInterfaceWindowDeleteBtn');
var copy = document.querySelector('#copy');
var copyInput = document.querySelector('#copyInput');
var inputTitle = document.querySelector('#inputTitle');
var outputTitle = document.querySelector('#outputTitle');
var validCharacters = '0123456789 ';
var validBinaryCharacters = '01 ';
formEl.addEventListener('submit', function (e) {
  e.preventDefault();
  var inputValue = e.target.input.value;
  var inputType = e.target.input.getAttribute('data-type');
  var isValid2 = encryptor_toConsumableArray(inputValue).every(function (_char) {
    return validBinaryCharacters.includes(_char);
  });
  var isValid = encryptor_toConsumableArray(inputValue).every(function (_char2) {
    return validCharacters.includes(_char2);
  });
  var type2 = inputEl.getAttribute('data-type');
  console.log(type2);
...
switchEl.addEventListener('click', function (e) {
  ...
  if (type === 'binary') {
    ...
    if (inputEl.value === 'Вывод текста...' || inputEl.value === 'Вывод шифра...' || inputEl.value === 'Введите значения двоичного кода' || inputEl.value === 'Введите свой текст' || inputEl.value === 'Введите свой шифр') {
      inputEl.value = '';
    }
  } else if (type === 'text') {
    inputEl.value = outputEl.innerText;
...
function binaryToText(input) {
  var output = '';
  output = input.split(' ').map(function (number) {
...
function textToBinary(input) {
  var output = '';
  output = input.split('').map(function (latter) {
